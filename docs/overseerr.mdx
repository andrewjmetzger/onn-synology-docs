...
serverIp: "diskstation.tail580c0.ts.net"
---
...
**Overseerr** is a user-friendly request system that can automatically search for and grab the media you're after. To access Overseer, visit <code>http://{frontMatter.serverIP}:5055</code>.
