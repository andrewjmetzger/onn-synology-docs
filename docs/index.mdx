...
Connecting any smart TV to the network *is not supported*, as doing so may lead to unexpected behavior.
:::
...
![](docs/img/hw-ds918plus.png)

### onn Google TV 4K Streaming Box (2023)

![](docs/img/hw-onn4k-gtv.png)
...
Congratulations! Once Plex is up and running, you can [add additional content](/overseerr).
