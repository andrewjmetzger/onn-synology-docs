...
![](assets/img/hardware/hw-ds918plus.png)

Datasheet: [PDF](assets/Synology_DS918_Plus_Data_Sheet_enu.pdf)

### onn 4K Streaming Box Google TV (2023)

![](assets/img/hardware/hw-onn4k-gtv.png)

Manual: [PDF](assets/onn4k-gtv-manual-DV6105Z_QSG.pdf)

## Hardware Setup

:::warning[Do not connect your Smart TV to the network!]

The Synology NAS and accompanying Onn streaming box should be the only "TV" devices to have network access.
